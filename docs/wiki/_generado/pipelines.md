...
| [azure-pipelines-leads.yml](../../../pipelines/azure-pipelines-leads.yml) | `fa-axxonleads` | si | no | `tests/AxxonLeads.Functions.Tests/AxxonLeads.Functions.Tests.csproj` |
...
| `fa-axxonleads` | `src/integrations/leads/AxxonLeads.Functions/**`<br>`tests/AxxonLeads.Functions.Tests/**`<br>`src/core/**`<br>`pipelines/azure-pipelines-leads.yml`<br>`pipelines/templates/functionapp-build-deploy.yml`<br>`pipelines/templates/functionapp-deploy-stage.yml` |
