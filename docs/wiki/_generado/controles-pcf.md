...
| `RucValidatorControl` | `AxxonContacts` | `1.1.0` | `DocumentNumber (bound, SingleLine.Text)`, `ApiBaseUrl (input, SingleLine.URL)`, `ApiKey (input, SingleLine.Text)` | `src/integrations/contacts/AxxonContacts.PCF` |
