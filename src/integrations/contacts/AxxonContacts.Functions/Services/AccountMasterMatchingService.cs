    ...
    public class AccountMasterMatchingService
    {
        ...
        private async Task<EntityReference> CreateMasterAsync(AccountEventMessage message)
        {
            ...
            try
            {
                ...
                await CopyStreetNumberToMasterAsync(message.AccountId, masterId);
        ...
        ///
        /// Hace falta porque msdyn_streetnumber NO es un atributo del account: vive solo
        ...
        /// calle queda atras porque no tiene proyeccion en el account. Dataverse crea el
        ...
        private async Task CopyStreetNumberToMasterAsync(Guid rawId, Guid masterId)
        {
            try
            {
                ...
                {
                    _logger.LogWarning(
                        "[AccountMasterMatchingService] Master {MasterId} sin customeraddress 1. StreetNumber no copiado.",
                        masterId);
                    return;
                }
                ...
                _logger.LogInformation(
                    "[AccountMasterMatchingService] StreetNumber '{StreetNumber}' copiado al master {MasterId}.",
            ...
            catch (Exception ex)
            {
                ...
                _logger.LogWarning(ex,
                    "[AccountMasterMatchingService] No se pudo copiar StreetNumber del raw {RawId} al master {MasterId}.",
                    rawId, masterId);
            }
        }
