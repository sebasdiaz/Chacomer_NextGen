...
const SELECT_FIELDS = "accountid,name,_msdyn_company_value,_msdyn_customergroupid_value,_msdyn_paymentterms_value";
...
export const ChildAccountsGrid: React.FC<IChildAccountsGridProps> = ({ masterContactId, webAPI }) => {
