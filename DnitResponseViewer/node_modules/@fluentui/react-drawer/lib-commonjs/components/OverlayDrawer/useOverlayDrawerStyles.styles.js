 ...
 */ const useDrawerResetStyles = /*#__PURE__*/ (0, _react.__resetStyles)("r7dfyj8", "rmx02j7", {
    r: [
...
const useOverlayDrawerStyles_unstable = (state)=>{
    ...
    state.root.className = (0, _react.mergeClasses)(overlayDrawerClassNames.root, baseClassNames, resetStyles, rootStyles[state.position], absoluteStyles, state.root.className);
    if (backdrop) {
        // eslint-disable-next-line react-hooks/immutability
        backdrop.className = (0, _react.mergeClasses)(overlayDrawerClassNames.backdrop, absoluteStyles, backdrop.className);
    }
    return state;
};
