...
import { ChildContactsGrid, IChildContactsGridProps } from "./ChildContactsGrid";
...
export class MasterContactChildrenGrid implements ComponentFramework.ReactControl<IInputs, IOutputs> {
    ...
    public updateView(context: ComponentFramework.Context<IInputs>): React.ReactElement {
        ...
        const props: IChildContactsGridProps = {
            masterContactId,
            webAPI: context.webAPI,
        };

        return React.createElement(ChildContactsGrid, props);
    }
